---
name: duya-positioning
description: "判断应该服务谁、客户为什么购买、产品怎样承接定位。用于目标客户模糊、卖点说不清、客户觉得不值或产品与承诺不匹配。"
metadata:
  duya_component: true
---
...
2. 本轮已选择“客户与商业定位”，继续读取并执行 [对应工作方法](../duya/internal/duya-positioning/GUIDE.md)。直接完成用户要的判断、稿件、文件或动作，不把推荐另一个命令当作交付。
...
示例：`客户总觉得我的获客陪跑只是教拍视频，帮我说清购买理由和产品价值。`
