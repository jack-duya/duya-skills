---
name: duya-matrix
description: "设计自营账号、素人和达人合作的分发模式，以及图文和短视频批量生产。处理账号职责、素材复用、差异内容和协作投入。"
metadata:
  duya_component: true
---
...
2. 本轮已选择“矩阵与批量生产”，继续读取并执行 [对应工作方法](../duya/internal/duya-matrix/GUIDE.md)。直接完成用户要的判断、稿件、文件或动作，不把推荐另一个命令当作交付。
...
示例：`三家门店都有现场素材，总部一位剪辑，设计账号分工和素材量产方式。`
