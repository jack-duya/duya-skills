---
name: duya-diagnose
description: "排查没流量、咨询少、人群不对、账号异常和投入失效。结合商业与内容知识由果推因，重新定义问题并给具体改法。"
metadata:
  duya_component: true
---
...
2. 本轮已选择“获客问题诊断”，继续读取并执行 [对应工作方法](../duya/internal/duya-diagnose/GUIDE.md)。直接完成用户要的判断、稿件、文件或动作，不把推荐另一个命令当作交付。
...
示例：`装修视频评论都是同行，业主咨询很少，我该加账号还是改内容？`
