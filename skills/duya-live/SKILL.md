---
name: duya-live
description: "设计获客直播话题、整场结构、讲稿和过渡，或依据现有回放排查进房、留人和表达问题，给可以直接替换的讲法。"
metadata:
  duya_component: true
---
...
2. 本轮已选择“获客直播”，继续读取并执行 [对应工作方法](../duya/internal/duya-live/GUIDE.md)。直接完成用户要的判断、稿件、文件或动作，不把推荐另一个命令当作交付。
...
示例：`这段直播讲解太专业，观众听不懂，帮我找断点并写能直接替换的讲稿。`
