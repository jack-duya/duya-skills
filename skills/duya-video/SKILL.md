---
name: duya-video
description: "创作与改写以获客为目的的短视频，优化开头、口播、情绪和镜头安排。交付完整可拍稿，按抖音、小红书和视频号的具体需要适配。"
metadata:
  duya_component: true
---
...
2. 本轮已选择“线索短视频”，继续读取并执行 [对应工作方法](../duya/internal/duya-video/GUIDE.md)。直接完成用户要的判断、稿件、文件或动作，不把推荐另一个命令当作交付。
...
示例：`把这段装修口播改得像老板在工地跟业主说话，给完整旁白和镜头顺序。`
